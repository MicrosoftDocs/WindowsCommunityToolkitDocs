...
> [!NOTE]
> Since the `WeakReferenceMessenger` violates [Explicit dependencies](https://docs.microsoft.com/en-us/dotnet/architecture/modern-web-apps-azure/architectural-principles#explicit-dependencies) architectural principle, user shall consider avoiding excessive using of `WeakReferenceMessenger`

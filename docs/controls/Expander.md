...
[Expander XAML File](https://github.com/microsoft/microsoft-ui-xaml/blob/main/dev/Expander/Expander.xaml) is the XAML template used in the toolkit for the default styling.

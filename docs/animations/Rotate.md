...
Rotate Behavior Sample Page Source. You can [see this in action](uwpct://Animations?sample=Rotate) in the [Windows Community Toolkit Sample App](https://aka.ms/windowstoolkitapp).

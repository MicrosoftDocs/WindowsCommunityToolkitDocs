...
Light Behavior Sample Page Source . You can [see this in action](uwpct://Animations?sample=Light) in the [Windows Community Toolkit Sample App](https://aka.ms/windowstoolkitapp).
...
- [SceneLightingEffect Class](/uwp/api/Windows.UI.Composition.Effects.SceneLightingEffect)

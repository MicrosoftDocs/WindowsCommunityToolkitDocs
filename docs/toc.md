...
### [How to: Add a DataGrid control to a page](datagrid_guidance/datagrid_basics.md)
### [How to: Customize the DataGrid control using styling and formatting options](datagrid_guidance/styling_formatting_options.md)
### [How to: Display and configure Row Details](datagrid_guidance/rowdetails.md)
### [How to: Configure Auto-generated columns in the DataGrid control](datagrid_guidance/customize_autogenerated_columns.md)
### [How to: Group, sort and filter data using LINQ and the DataGrid control](datagrid_guidance/group_sort_filter.md)
### [How to: Edit and perform input validation in the DataGrid control](datagrid_guidance/editing_inputvalidation.md)
